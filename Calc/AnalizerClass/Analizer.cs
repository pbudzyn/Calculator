...
namespace AnalizerClass
{
    public class Analizer
    {
        ...
        /// помилка</returns>
        /// Метод пробігається по вхідному виразу, символ за символом аналізуючи
        ...
        /// пропуски і видаляючи зайві, також знаходить нерозпізнані оператори, стежить за кінцем рядка,
